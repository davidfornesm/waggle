...
impl<W: Write> ser::Serializer for KeySerializer<'_, '_, W> {
    ...
    fn serialize_i8(self, _v: i8) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("i8"))
    }

    fn serialize_i16(self, _v: i16) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("i16"))
    }

    fn serialize_i32(self, _v: i32) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("i32"))
    }

    fn serialize_i64(self, _v: i64) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("i64"))
    }

    fn serialize_i128(self, _v: i128) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("i128"))
    }

    fn serialize_u8(self, _v: u8) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("u8"))
    }

    fn serialize_u16(self, _v: u16) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("u16"))
    }

    fn serialize_u32(self, _v: u32) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("u32"))
    }

    fn serialize_u64(self, _v: u64) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("u64"))
    }

    fn serialize_u128(self, _v: u128) -> Result<Self::Ok, Self::Error> {
        Err(Self::Error::NotSupported("u128"))
    }
    ...
    where
        T: ?Sized + Serialize,
    {
        Err(Self::Error::NotSupported("newtype_variant"))
    }

    fn serialize_seq(self, _len: Option<usize>) -> Result<Self::SerializeSeq, Self::Error> {
        Err(Self::Error::NotSupported("seq"))
    }

    fn serialize_tuple(self, _len: usize) -> Result<Self::SerializeTuple, Self::Error> {
        Err(Self::Error::NotSupported("tuple"))
    }
    ...
    fn serialize_tuple_struct(
        ...
        Err(Self::Error::NotSupported("tuple_struct"))
    }
    ...
    fn serialize_tuple_variant(
        ...
        Err(Self::Error::NotSupported("tuple_variant"))
    }

    fn serialize_map(self, _len: Option<usize>) -> Result<Self::SerializeMap, Self::Error> {
        Err(Self::Error::NotSupported("map"))
    }
    ...
    fn serialize_struct(
        ...
        Err(Self::Error::NotSupported("struct"))
    }
    ...
    fn serialize_struct_variant(
        ...
        Err(Self::Error::NotSupported("struct_variant"))
    }
        ...
        T: ?Sized + Serialize,
    {
        match self.map_state {
            MapState::New | MapState::AwaitingKey => {
                return Err(crate::error::Error::MalformedEntry);
            }
...
impl<W: Write> Serializer<W> {
    ...
    fn write_number_prefix(&mut self) -> crate::error::Result<()> {
        self.writer.write_all(b"i")?;
        Ok(())
    }

    fn write_list_prefix(&mut self) -> crate::error::Result<()> {
        self.writer.write_all(b"l")?;
        Ok(())
    }

    fn write_dictionary_prefix(&mut self) -> crate::error::Result<()> {
        self.writer.write_all(b"d")?;
        Ok(())
    }

    fn write_end_suffix(&mut self) -> crate::error::Result<()> {
...
impl<'s, W: Write> ListSerializer<'s, W> {
    ...
    fn finish(self) -> crate::error::Result<&'s mut Serializer<W>> {
...
impl<'s, W: Write> MapSerializer<'s, W> {
    ...
    fn write_key(&mut self, v: &[u8]) -> crate::error::Result<()> {
        match self.map_state {
            MapState::New => {}
            MapState::AwaitingKey => match v.cmp(&self.last_key) {
                Ordering::Less => return Err(crate::error::Error::UnsortedKey),
                Ordering::Equal => return Err(crate::error::Error::DuplicateKey),
                Ordering::Greater => {}
            },
            MapState::AwaitingValue => return Err(crate::error::Error::MalformedEntry),
        }
        self.serializer.write_bytes(v)?;
        self.last_key.clear();
        self.last_key.extend_from_slice(v);
